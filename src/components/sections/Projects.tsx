  ...
  return (
    <div className="relative h-40 w-full overflow-hidden rounded-xl bg-slate-800/80 md:h-48">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <span className="font-mono text-xs text-slate-500">Project preview</span>
      </div>
    </div>
  );
}
    ...
    <div className="relative mt-4 select-none overflow-hidden rounded-xl border border-slate-700/50">
      <div className="relative h-32 md:h-36">
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-red-950/60 to-slate-900 p-4 text-center">
          <p className="text-xs text-red-300/90 md:text-sm">{beforeLabel}</p>
        </div>
        <div
        ...
        >
          <p className="text-xs text-emerald-300/90 md:text-sm">{afterLabel}</p>
        </div>
        <input
          type="range"
          min={5}
        ...
        <div className="p-5 md:p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <button
              ...
              className="rounded-full border border-slate-600 px-4 py-2 text-xs font-medium text-slate-300 transition hover:border-sky-500/50"
            >
            ...
            <button
              ...
              className="rounded-full bg-sky-500/20 px-4 py-2 text-xs font-medium text-sky-300 transition hover:bg-sky-500/30"
            >
              ...
              >
                ...
                <ul className="mt-2 space-y-2">
                  {project.whatIDid.map((item) => (
                    <li
                      key={item}
                      className="flex gap-2 text-sm text-slate-400 before:content-['→']"
                    >
                      {item}
                    </li>
                  ))}
          ...
          <AnimatePresence>
            {caseStudyOpen && (
              ...
              >
                <p className="font-mono text-xs text-violet-300">Case study mode</p>
